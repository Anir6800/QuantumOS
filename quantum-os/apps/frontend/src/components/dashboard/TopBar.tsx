...
export function TopBar() {
  ...
  return (
    <div className="h-16 border-b border-white/10 bg-black/20 backdrop-blur-md flex items-center justify-between px-4 md:px-6 lg:px-8 flex-shrink-0 shadow-sm z-20 relative">
      <div>
