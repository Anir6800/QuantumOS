    ...
    <section className="py-32 relative overflow-hidden bg-[#050508] border-t border-white/5">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-2xl mx-auto font-mono">
            Join the waitlist or start deploying local swarms today.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <Magnetic strength={25}>
              <button className="relative group w-full sm:w-auto bg-[#00e5ff] text-[#050508] px-10 py-5 rounded-xl font-black text-xl hover:bg-white transition-all overflow-hidden shadow-[0_0_40px_rgba(0,229,255,0.3)] hover:shadow-[0_0_60px_rgba(0,229,255,0.6)]">
