...
SYSTEM_PROMPT = """You are a security-focused software engineer.
Priority: input validation, SQL injection prevention, rate limiting, auth.
Prefer: parameterized queries, principle of least privilege, audit logging.
Write complete, runnable code with all security measures implemented."""
...
class SecurityAgent(BaseAgent):
    ...
    async def execute(self, task: dict) -> AgentResult:
        ...
        system_prompt = await self._inject_sibling_context(
            ...
            specialty="security hardening and validation",
        )
